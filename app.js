...
tl2.to('.cornsilk', { rotation: '360', transformOrigin: 'center', repeat: -1, duration: 8, ease: Power0.easeNone })
tl3.to('.red', { rotation: '-360', transformOrigin: 'center', repeat: -1, duration: 8, ease: Power0.easeNone })
